...
- **Consequence:** If the timer reaches 0 before achieving 10 hits, the runner receives a "Time's Up!" prompt and must restart the challenge from zero hits. 
...
- **Completion:** The game is completed once all 6 pairs have been correctly matched. 
...
- **Consequence:** If the runner taps a wrong block, the screen flashes red ("Wrong sequence! Restarting..."), buzzes prominently, and after a short 1-second delay, a completely new sequence of 4 blocks is generated for the runner to attempt.
- **Completion:** Replicating the exact sequence of 4 blocks clears the challenge.
